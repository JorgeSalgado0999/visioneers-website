				...
				<section className={` ${styles.bulletPointsContainer}`}>
					...
					<div className={styles.bulletsRightSide}>
						<div className={styles.bulletPoint}>
							...
							<p>
								Más allá de enseñar inglés, nos enfocamos en ampliar y
								fortalecer las habilidades de comunicación en inglés y
								liderazgo, a través del desarrollo de la inteligencia emocional,
						...
						<div className={styles.bulletPoint}>
							...
							<p>
								...
								tu empresa, ya sea para fortalecer la integración del equipo,
